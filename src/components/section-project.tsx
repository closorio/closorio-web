...
const Image: FC<ImageProps> = ({ src, alt }) => (
  <img
    alt={alt}
    className="object-cover object-center w-full h-full transition-transform duration-500 group-hover:rotate-2 group-hover:scale-125"
    src={src}
  />
);
      ...
      <div className="container px-4 mx-auto">
        <div className="flex -mx-4 -mb-10 text-center flex-col md:flex-row">
          ...
          <div className="md:w-1/2 md:mb-10 mb-5">
            <div className="group relative aspect-video rounded-lg overflow-hidden cursor-pointer transition-shadow hover:shadow-black/30">
