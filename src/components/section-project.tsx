...
const SectionProject: FC<SectionProjectProps> = ({
  ...
  const badgeStyles: { [key: string]: string } = {
    ...
    Vercel: "bg-gray-100 text-black-800 border-gray-700",
    Javascript: "bg-yellow-100 text-yellow-800 border-yellow-400",
    Typescript: "bg-blue-100 text-blue-600 border-blue-400",
    Express: "bg-gray-100 text-gray-800 border-gray-400",
    "Tailwind CSS": "bg-blue-100 text-blue-400 border-blue-400",
