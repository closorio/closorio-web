const MainSection = () => {
  return (
    <>
      <section
        id="section-home"
        className="text-gray-600 body-font bg-hero-pattern min-h-screen border-4"
      >
        <div className="container px-5 py-20 mx-auto">
          <div className="flex -mx-4 -mb-10 text-center">
            <div className="sm:w-1/2 mb-10 mx-auto px-4">
              <div className="rounded-full h-40 w-40 overflow-hidden border-solid border-4 border-white mx-auto shadow hover:shadow-lg hover:scale-110 transition ">
                <img
                  alt="content"
              ...
              <h2 className="title-font text-5xl font-bold text-gray-900 mt-6 mb-3">
              ...
              <span className="inline-flex sm:ml-auto mt-5 justify-center sm:justify-start">
                <a className="text-gray-500" href="https://github.com/closorio" target="_blank" rel="noopener noreferrer">
                  <svg
                ...
                <a className="ml-3 text-gray-500" href="https://www.linkedin.com/in/closorio" target="_blank" rel="noopener noreferrer">
                  <svg
                    fill="currentColor"
                    strokeWidth="2"
                    className="w-10 h-10"
